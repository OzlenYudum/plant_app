...
mixin _$CategoryModel {
 ...
 int get id; String get name; DateTime get createdAt; DateTime get updatedAt; DateTime get publishedAt; String get title; int get rank; CategoryImageModel get image;
...
@useResult
$Res call({
 int id, String name, DateTime createdAt, DateTime updatedAt, DateTime publishedAt, String title, int rank, CategoryImageModel image
});
...
$CategoryImageModelCopyWith<$Res> get image {
  ...
  return $CategoryImageModelCopyWith<$Res>(_self.image, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name,  DateTime createdAt,  DateTime updatedAt,  DateTime publishedAt,  String title,  int rank,  CategoryImageModel image)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CategoryModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name,  DateTime createdAt,  DateTime updatedAt,  DateTime publishedAt,  String title,  int rank,  CategoryImageModel image)  $default,) {final _that = this;
switch (_that) {
case _CategoryModel():
return $default(_that.id,_that.name,_that.createdAt,_that.updatedAt,_that.publishedAt,_that.title,_that.rank,_that.image);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String name,  DateTime createdAt,  DateTime updatedAt,  DateTime publishedAt,  String title,  int rank,  CategoryImageModel image)?  $default,) {final _that = this;
switch (_that) {
case _CategoryModel() when $default != null:
return $default(_that.id,_that.name,_that.createdAt,_that.updatedAt,_that.publishedAt,_that.title,_that.rank,_that.image);case _:
  return null;
...
class _CategoryModel implements CategoryModel {
  const _CategoryModel({required this.id, required this.name, required this.createdAt, required this.updatedAt, required this.publishedAt, required this.title, required this.rank, required this.image});
...
@override final  CategoryImageModel image;
...
@override $CategoryImageModelCopyWith<$Res> get image;
